...
/**
 * @ngdoc object
 * @name lbServices.Prescription
 * @header lbServices.Prescription
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Prescription` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/prescriptions/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Prescription#create
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Prescription` object.)
         * </em>
         */
        "create": {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#createMany
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#upsert
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#exists
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/prescriptions/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Prescription#findById
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/prescriptions/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Prescription#find
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#findOne
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/prescriptions/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Prescription#updateAll
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/prescriptions/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Prescription#deleteById
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#count
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/prescriptions/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Prescription#prototype$updateAttributes
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#createChangeStream
         * @methodOf lbServices.Prescription
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/prescriptions/change-stream",
          method: "POST"
        },

        // INTERNAL. Use Dosage.prescriptions.findById() instead.
        "::findById::dosage::prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
          method: "GET"
        },

        // INTERNAL. Use Dosage.prescriptions.destroyById() instead.
        "::destroyById::dosage::prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
        ...
        // INTERNAL. Use Dosage.prescriptions.updateById() instead.
        "::updateById::dosage::prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
        ...
        // INTERNAL. Use Dosage.prescriptions() instead.
        "::get::dosage::prescriptions": {
          isArray: true,
          url: urlBase + "/dosages/:id/prescriptions",
          method: "GET"
        },

        // INTERNAL. Use Dosage.prescriptions.create() instead.
        "::create::dosage::prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions",
          method: "POST"
        },

        // INTERNAL. Use Dosage.prescriptions.createMany() instead.
        "::createMany::dosage::prescriptions": {
          isArray: true,
          url: urlBase + "/dosages/:id/prescriptions",
          method: "POST"
        },

        // INTERNAL. Use Dosage.prescriptions.destroyAll() instead.
        "::delete::dosage::prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions",
          method: "DELETE"
        },

        // INTERNAL. Use Dosage.prescriptions.count() instead.
        "::count::dosage::prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions/count",
          method: "GET"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#updateOrCreate
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#update
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#destroyById
         * @methodOf lbServices.Prescription
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Prescription#removeById
         * @methodOf lbServices.Prescription
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Prescription#modelName
    * @propertyOf lbServices.Prescription
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Prescription`.
    */
    R.modelName = "Prescription";
...
/**
 * @ngdoc object
 * @name lbServices.Dosage
 * @header lbServices.Dosage
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Dosage` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Dosage.prescriptions.findById() instead.
        "prototype$__findById__prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
        ...
        // INTERNAL. Use Dosage.prescriptions.destroyById() instead.
        "prototype$__destroyById__prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
        ...
        // INTERNAL. Use Dosage.prescriptions.updateById() instead.
        "prototype$__updateById__prescriptions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/dosages/:id/prescriptions/:fk",
        ...
        // INTERNAL. Use Dosage.prescriptions() instead.
        "prototype$__get__prescriptions": {
          isArray: true,
          url: urlBase + "/dosages/:id/prescriptions",
          method: "GET"
        },
        ...
        // INTERNAL. Use Dosage.prescriptions.create() instead.
        "prototype$__create__prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions",
          method: "POST"
        },

        // INTERNAL. Use Dosage.prescriptions.destroyAll() instead.
        "prototype$__delete__prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions",
          method: "DELETE"
        },

        // INTERNAL. Use Dosage.prescriptions.count() instead.
        "prototype$__count__prescriptions": {
          url: urlBase + "/dosages/:id/prescriptions/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#create
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Dosage` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/dosages",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#createMany
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/dosages/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Dosage#findById
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/dosages/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Dosage#find
         * @methodOf lbServices.Dosage
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#findOne
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/dosages/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Dosage#updateAll
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/dosages/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Dosage#deleteById
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/dosages/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Dosage#prototype$updateAttributes
         * @methodOf lbServices.Dosage
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#createChangeStream
         * @methodOf lbServices.Dosage
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/dosages/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#updateOrCreate
         * @methodOf lbServices.Dosage
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#destroyById
         * @methodOf lbServices.Dosage
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Dosage#removeById
         * @methodOf lbServices.Dosage
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Dosage#modelName
    * @propertyOf lbServices.Dosage
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Dosage`.
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Dosage.prescriptions
     * @header lbServices.Dosage.prescriptions
     * @object
     * @description
     *
     * The object `Dosage.prescriptions` groups methods
     * manipulating `Prescription` instances related to `Dosage`.
     *
     * Call {@link lbServices.Dosage#prescriptions Dosage.prescriptions()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries prescriptions of dosage.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.prescriptions = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::get::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#count
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Counts prescriptions of dosage.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.prescriptions.count = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::count::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#create
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Creates a new instance in prescriptions of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.prescriptions.create = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::create::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#createMany
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         ...
         * </em>
         */
        R.prescriptions.createMany = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::createMany::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#destroyAll
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Deletes all prescriptions of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.prescriptions.destroyAll = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::delete::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#destroyById
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Delete a related item by id for prescriptions.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for prescriptions
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.prescriptions.destroyById = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::destroyById::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#findById
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Find a related item by id for prescriptions.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.prescriptions.findById = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::findById::dosage::prescriptions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Dosage.prescriptions#updateById
         * @methodOf lbServices.Dosage.prescriptions
         *
         * @description
         *
         * Update a related item by id for prescriptions.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.prescriptions.updateById = function() {
          var TargetResource = $injector.get("Prescription");
          var action = TargetResource["::updateById::dosage::prescriptions"];
          return action.apply(R, arguments);
        };
